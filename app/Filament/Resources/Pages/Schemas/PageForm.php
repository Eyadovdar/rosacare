                        ...
                        Tab::make('English (en)')
                            ->schema([
                                ...
                                Builder::make('content:en')
                                    ...
                                    ->blockPickerColumns(3)
                                    ->blocks([
                                        // Use the same blocks as Arabic - they're defined above
                                        // For now, copy the blocks structure, or we can refactor to a helper method
                                        Builder\Block::make('paragraph')
                                            ->label('Paragraph')
                                            ->icon('heroicon-o-bars-3-bottom-left')
                                            ->schema([
                                        ...
                                        // Note: Add all other blocks here or extract to a helper method
                                    ])
