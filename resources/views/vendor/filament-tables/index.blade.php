                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        @foreach ($sortableColumns as $column)
                                                            @php
                                                                $optionLabel = $column->getLabel();
                                                                $optionLabel = $optionLabel instanceof \Illuminate\Contracts\Support\Htmlable ? ($column->getHeaderTooltip() ?? strip_tags($optionLabel->toHtml())) : $optionLabel;
                                                            @endphp
                                                            <option
                                    ...
                                    @foreach ($columns as $column)
                                        ...
                                        @else
                                            ...
                                            >
                                                @if ($isColumnSortable)
                                                    <span
                                                        aria-label="{{ trim(strip_tags($columnLabel instanceof \Illuminate\Contracts\Support\Htmlable ? $columnLabel->toHtml() : $columnLabel)) }}"
                                                        role="button"
                                                        tabindex="0"
                                                    ...
                                                    >
                                                        @if (filled($columnHeaderTooltip))
                                                            ...
                                                            >
                                                                @if($columnLabel instanceof \Illuminate\Contracts\Support\Htmlable){!! $columnLabel !!}@else{{ $columnLabel }}@endif
                                                            </span>
                                                        @else
                                                            @if($columnLabel instanceof \Illuminate\Contracts\Support\Htmlable){!! $columnLabel !!}@else{{ $columnLabel }}@endif
                                                        @endif
